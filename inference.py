...
# Define paths
WEIGHTS_DIR = r"C:\Users\Navya\Downloads\Person and PPE detection\Person and PPE detection\weights"
PERSON_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_person.pt")
PPE_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_ppe.pt")
INPUT_DIR = r"C:\Users\Navya\Downloads\Person and PPE detection\Person and PPE detection\input_directory"
OUTPUT_DIR = r"C:\Users\Navya\Downloads\Person and PPE detection\Person and PPE detection\output_directory"
...
if __name__ == "__main__":
    ...
    # Load YOLO models and print paths for debugging
